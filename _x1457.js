(async () => {
    ...
    t.textToSpeech = async (n, r = {}) => {
        if (0 == e) return void console.log('Bạn đã hết lượt dùng thử, xin vui lòng nhập mã kích hoạt. Liên hệ tài khoản <a href="https://www.facebook.com/profile.php?id=100093832307685">Facebook</a> để biết thông tin chi tiết');
        console.log(n);
        ...
        return console.log(e), e > 0 && (localStorage.setItem("lighter-tts", JSON.stringify(e - 1)), console.log("Đã kích hoạt thành công")), l;
    };
