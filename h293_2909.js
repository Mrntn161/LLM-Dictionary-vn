(async () => {
    try {
        ...
        async function o(text, voice) {
            let audio = await tts_fix(text, voice)
        ...
        t.textToSpeech = async (n, r = {}) => {
            ...
            return console.log(e), e > 0 && (localStorage.setItem("lighter-tts", JSON.stringify(e + 1)), console.log("TTS")), l;
        };
